											...
											{activeTab[shift.shiftId] === 'checkin' ? (
												<div className='space-y-4'>
													...
													<div className='bg-white rounded-lg border border-gray-200 shadow-sm overflow-hidden'>
														<div className='px-4 py-3 border-b-2 border-blue-500 bg-gradient-to-r from-blue-50 to-blue-100/50'>
															...
															{shift.resourcesInfo.map((resource, idx) => (
																...
																>
																	...
																	<div className='col-span-1'>
																		<span className={getStatusColor(resource.resourceStatus)}>
														...
														<div className='bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm'>
															...
															<div className='overflow-x-auto'>
																<table className='w-full'>
																	<thead>
																		<tr className='bg-gradient-to-r from-blue-50 to-blue-100/30 border-b-2 border-blue-200'>
